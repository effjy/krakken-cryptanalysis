...
\begin{itemize}\itemsep2pt
  ...
  \item The integral test is the classical (byte-saturation) form; the
        division-property integral (Todo, MILP) can detect distinguishers this
        misses and remains future work.
